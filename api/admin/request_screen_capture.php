...
if ($userData['role'] !== 'admin') {
    Response::error(403, "Only admins can request screen captures");
}
...
try {
    ...
    $query = "INSERT INTO screen_captures (employee_id, requested_by, capture_type, status) 
              VALUES (:employee_id, :admin_id, 'screenshot', 'pending')";
    ...
    Response::send(200, [
        'message' => 'Screen capture requested successfully',
        'capture_id' => $captureId,
    ...
    error_log("Screen capture DB error: " . $e->getMessage());
